...
def enviador_correos(correos,tu_correo,contra,asunto,mensaje):
...
def alerta_correo(correo,tucorreo,contraseña,x):
	...
	enviador_correos(correo,tucorreo,contraseña,dicc_alertas[x],dicc_mensajes[x])



def correo(correo,tucorreo,contraseña,asunto,mensaje):
	
	enviador_correos(correo,tucorreo,contraseña,asunto,mensaje)
